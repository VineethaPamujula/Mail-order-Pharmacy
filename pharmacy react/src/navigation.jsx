                ...
                <div>
                    <div className="container">
                        <div className="cards">
                            ...
                            <div className="card-wrapper"><img src={caps1} alt="Capsule 1" /></div>
                            <div className="card-wrapper"><img src={caps7} alt="Capsule 7" /></div>
                            <div className="card-wrapper"><img src={caps4} alt="Capsule 4" /></div>
                            <div className="card-wrapper"><img src={caps8} alt="Capsule 8" /></div>
                            <div className="card-wrapper"><img src={caps10} alt="Capsule 10" /></div>
